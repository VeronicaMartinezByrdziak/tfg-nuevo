...
if st.session_state.pantalla == "prediccion":
    ...
    if st.button("Predecir"):
        ...
        # =====================================================
        # RECOMENDACIÓN DE COMPLETAR CON BIOMARCADORES / MRI
        # SOLO PARA EL MODELO CLÍNICO
        # =====================================================
        if st.session_state.modelo == "clinico":
            ...
            if pred == 1:
                st.info(
                    "Este resultado se ha obtenido únicamente con variables clínicas y cognitivas. "
                    "Para una estimación más completa del riesgo, sería recomendable complementar "
                    "la evaluación con información biomédica adicional, especialmente resonancia magnética cerebral."
                )

            elif caso_incierto:
                st.info(
                    "Aunque el riesgo estimado es bajo, el resultado está próximo al umbral de decisión. "
                    "Podría ser útil completar la evaluación con información biomédica adicional, "
                    "especialmente resonancia magnética cerebral, para reducir la incertidumbre."
                )
